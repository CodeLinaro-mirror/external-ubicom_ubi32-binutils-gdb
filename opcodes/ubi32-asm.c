...
/* Directly addressable registers on the UBI32.
 */
...
struct ubi32_cgen_data_space_map ubi32_cgen_data_space_map_mercury[] = {
...
struct ubi32_cgen_data_space_map ubi32_cgen_data_space_map_mars[] = {
	{ 0x0,		"d0", RW, },	/* data registers */
	/* d1, d2 and d3 are later */
	{ 0x10,		"d4", RW, },
	{ 0x14,		"d5", RW, },
...
struct ubi32_cgen_data_space_map ubi32_cgen_data_space_map_jupiter[] = {
	{ 0x0,		"d0", RW, },	/* data registers */
	/* d1, d2 and d3 are later */
	{ 0x10,		"d4", RW, },
	{ 0x14,		"d5", RW, },
...
struct ubi32_cgen_data_space_map ubi32_cgen_data_space_map_akronite[] = {
	{ 0x0,		"d0", RW, },	/* data registers */
	/* d1, d2 and d3 are later */
	{ 0x10,		"d4", RW, },
	{ 0x14,		"d5", RW, },
	...
	{ 0x208,	"i_range2_hi", RW},
	{ 0x20c,	"i_range3_hi", RW},
	{ 0x210,	"i_range4_hi", RW},
	{ 0x214,	"i_range5_hi", RW},
	...
	{ 0x228,	"i_range2_lo", RW},
	{ 0x22c,	"i_range3_lo", RW},
	{ 0x230,	"i_range4_lo", RW},
	{ 0x234,	"i_range5_lo", RW},
	...
	{ 0x248,	"i_range2_en", RW},
	{ 0x24c,	"i_range3_en", RW},
	{ 0x250,	"i_range4_en", RW},
	{ 0x254,	"i_range5_en", RW},
	...
	{ 0x2c8,	"i_range2_user_en", RW},
	{ 0x2cc,	"i_range3_user_en", RW},
	{ 0x2d0,	"i_range4_user_en", RW},
	{ 0x2d4,	"i_range5_user_en", RW},
	...
	{ 0x2f0,	"d_range4_user_en", RW},
	{ 0x2f4,	"d_range5_user_en", RW},
	{ 0x2f8,	"d_range6_user_en", RW},
	{ 0x2fc,	"d_range7_user_en", RW},
	     ...
	     long *valuep)
{
  ...
  if (strncasecmp (*strp, "%hi(", 4) == 0)
    {
      *strp += 4;
      errmsg = cgen_parse_address (cd, strp, opindex, BFD_RELOC_UBI32_HI24,
				   &result_type, &value);
      if (**strp != ')')
	return _("missing `)'");
      ++*strp;
		...
		unsigned long *valuep)
{
  ...
  if (**strp == '#')
    ...
    errmsg = cgen_parse_address (cd, strp, opindex, BFD_RELOC_UBI32_21_PCREL,
			       &result_type, &value);
		...
		long *valuep)
{
  ...
  if (strncasecmp (*strp, "%lo18(", 6) == 0)
    {
      *strp += 6;
      errmsg = cgen_parse_address (cd, strp, opindex, BFD_RELOC_UBI32_LO16_CALLI,
				   &result_type, &value);
      if (errmsg != NULL)
        return errmsg;
  ...
  /* Zero offset required ubi32v6.  */
  if ((cd->machs & (1<<MACH_UBI32_VER6)) && value != 0)
    return _("calli offset must be zero");
		...
		long *valuep)
{
  ...
  if (strncasecmp (*strp, "%lo(", 4) == 0)
    {
      *strp += 4;
      errmsg = cgen_parse_address (cd, strp, opindex, BFD_RELOC_UBI32_LO7_LEAI,
				   &result_type, &value);
      if (errmsg != NULL)
        return errmsg;
  ...
  if (strncasecmp (*strp, "%lo18(", 6) == 0)
    {
      *strp += 6;
      errmsg = cgen_parse_address (cd, strp, opindex, BFD_RELOC_UBI32_LO16_LEAI,
				   &result_type, &value);
      if (errmsg != NULL)
        return errmsg;
...
const char * ubi32_cgen_parse_operand
...
const char *
ubi32_cgen_parse_operand (CGEN_CPU_DESC cd,
			   int opindex,
			   const char ** strp,
			   CGEN_FIELDS * fields)
{
  ...
  switch (opindex)
    ...
    case UBI32_OPERAND_AM :
      errmsg = cgen_parse_keyword (cd, strp, & ubi32_cgen_opval_addr_names, & fields->f_Am);
      break;
    case UBI32_OPERAND_AN :
      errmsg = cgen_parse_keyword (cd, strp, & ubi32_cgen_opval_addr_names, & fields->f_An);
      break;
    case UBI32_OPERAND_C :
      errmsg = cgen_parse_keyword (cd, strp, & ubi32_cgen_opval_h_C, & fields->f_C);
      break;
    case UBI32_OPERAND_DN :
      errmsg = cgen_parse_keyword (cd, strp, & ubi32_cgen_opval_data_names, & fields->f_Dn);
      break;
    ...
    case UBI32_OPERAND_D_I4_2 :
      errmsg = parse_imm4_2 (cd, strp, UBI32_OPERAND_D_I4_2, (long *) (& fields->f_d_i4_2));
      break;
    case UBI32_OPERAND_D_I4_4 :
      errmsg = parse_imm4_4 (cd, strp, UBI32_OPERAND_D_I4_4, (long *) (& fields->f_d_i4_4));
      break;
    case UBI32_OPERAND_D_IMM7_1 :
      errmsg = parse_imm7_1_d (cd, strp, UBI32_OPERAND_D_IMM7_1, (unsigned long *) (& fields->f_d_imm7_1));
      break;
    case UBI32_OPERAND_D_IMM7_2 :
      errmsg = parse_imm7_2_d (cd, strp, UBI32_OPERAND_D_IMM7_2, (unsigned long *) (& fields->f_d_imm7_2));
      break;
    ...
    case UBI32_OPERAND_INTERRUPT :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_INTERRUPT, (unsigned long *) (& fields->f_int));
      break;
    case UBI32_OPERAND_IREAD :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_IREAD, (unsigned long *) (& junk));
      break;
    case UBI32_OPERAND_IRQ_0 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_IRQ_0, (unsigned long *) (& junk));
      break;
    ...
    case UBI32_OPERAND_OFFSET21 :
      {
        bfd_vma value = 0;
        errmsg = parse_offset21 (cd, strp, UBI32_OPERAND_OFFSET21, 0, NULL,  & value);
        fields->f_o21 = value;
      }
      break;
    case UBI32_OPERAND_OFFSET24 :
      {
        bfd_vma value = 0;
        errmsg = cgen_parse_address (cd, strp, UBI32_OPERAND_OFFSET24, 0, NULL,  & value);
        fields->f_o24 = value;
      }
      break;
    case UBI32_OPERAND_OPC1 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_OPC1, (unsigned long *) (& fields->f_op1));
      break;
    case UBI32_OPERAND_OPC2 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_OPC2, (unsigned long *) (& fields->f_op2));
      break;
    case UBI32_OPERAND_PDEC_S1_IMM7_4 :
      errmsg = parse_pdec_imm7_4_s (cd, strp, UBI32_OPERAND_PDEC_S1_IMM7_4, (unsigned long *) (& fields->f_s1_imm7_4));
      break;
    ...
    case UBI32_OPERAND_S1_I4_2 :
      errmsg = parse_imm4_2 (cd, strp, UBI32_OPERAND_S1_I4_2, (long *) (& fields->f_s1_i4_2));
      break;
    case UBI32_OPERAND_S1_I4_4 :
      errmsg = parse_imm4_4 (cd, strp, UBI32_OPERAND_S1_I4_4, (long *) (& fields->f_s1_i4_4));
      break;
    case UBI32_OPERAND_S1_IMM7_1 :
      errmsg = parse_imm7_1_s (cd, strp, UBI32_OPERAND_S1_IMM7_1, (unsigned long *) (& fields->f_s1_imm7_1));
      break;
    case UBI32_OPERAND_S1_IMM7_2 :
      errmsg = parse_imm7_2_s (cd, strp, UBI32_OPERAND_S1_IMM7_2, (unsigned long *) (& fields->f_s1_imm7_2));
      break;
    ...
    case UBI32_OPERAND_S2 :
      errmsg = cgen_parse_keyword (cd, strp, & ubi32_cgen_opval_data_names, & fields->f_s2);
      break;
    case UBI32_OPERAND_SRC3 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_SRC3, (unsigned long *) (& junk));
      break;
    case UBI32_OPERAND_X_BIT26 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_X_BIT26, (unsigned long *) (& fields->f_bit26));
      break;
    case UBI32_OPERAND_X_D :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_X_D, (unsigned long *) (& fields->f_d));
      break;
    case UBI32_OPERAND_X_DN :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_X_DN, (unsigned long *) (& fields->f_Dn));
      break;
    case UBI32_OPERAND_X_OP2 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_X_OP2, (unsigned long *) (& fields->f_op2));
      break;
    case UBI32_OPERAND_X_S1 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, UBI32_OPERAND_X_S1, (unsigned long *) (& fields->f_s1));
      break;
...
cgen_parse_fn * const ubi32_cgen_parse_handlers[] =
{
  parse_insn_normal,
};

void
ubi32_cgen_init_asm (CGEN_CPU_DESC cd)
{
  ubi32_cgen_init_opcode_table (cd);
  ubi32_cgen_init_ibld_table (cd);
  cd->parse_handlers = & ubi32_cgen_parse_handlers[0];
  cd->parse_operand = ubi32_cgen_parse_operand;
...
/* Regex construction routine.
   ...
   later use by ubi32_cgen_assemble_insn

   Returns NULL for success, an error message for failure.  */

char *
ubi32_cgen_build_insn_regex (CGEN_INSN *insn)
{
...
const CGEN_INSN *
ubi32_cgen_assemble_insn (CGEN_CPU_DESC cd,
			   const char *str,
			   CGEN_FIELDS *fields,
