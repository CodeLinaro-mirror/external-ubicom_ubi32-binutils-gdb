/* Instruction building/extraction support for ubi32. -*- C -*-
...
const char * ubi32_cgen_insert_operand
...
const char *
ubi32_cgen_insert_operand (CGEN_CPU_DESC cd,
			     int opindex,
			     CGEN_FIELDS * fields,
			     CGEN_INSN_BYTES_PTR buffer,
			     bfd_vma pc ATTRIBUTE_UNUSED)
...
int ubi32_cgen_extract_operand
...
int
ubi32_cgen_extract_operand (CGEN_CPU_DESC cd,
			     int opindex,
			     CGEN_EXTRACT_INFO *ex_info,
			     CGEN_INSN_INT insn_value,
			     CGEN_FIELDS * fields,
...
cgen_insert_fn * const ubi32_cgen_insert_handlers[] =
{
  insert_insn_normal,
};

cgen_extract_fn * const ubi32_cgen_extract_handlers[] =
{
  extract_insn_normal,
};

int ubi32_cgen_get_int_operand     (CGEN_CPU_DESC, int, const CGEN_FIELDS *);
bfd_vma ubi32_cgen_get_vma_operand (CGEN_CPU_DESC, int, const CGEN_FIELDS *);
...
int
ubi32_cgen_get_int_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
...
bfd_vma
ubi32_cgen_get_vma_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
			     const CGEN_FIELDS * fields)
{
  bfd_vma value;
...
void ubi32_cgen_set_int_operand  (CGEN_CPU_DESC, int, CGEN_FIELDS *, int);
void ubi32_cgen_set_vma_operand  (CGEN_CPU_DESC, int, CGEN_FIELDS *, bfd_vma);
...
void
ubi32_cgen_set_int_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
			     CGEN_FIELDS * fields,
			     int value)
{
...
void
ubi32_cgen_set_vma_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
			     CGEN_FIELDS * fields,
			     bfd_vma value)
{
...
void
ubi32_cgen_init_ibld_table (CGEN_CPU_DESC cd)
{
  cd->insert_handlers = & ubi32_cgen_insert_handlers[0];
  cd->extract_handlers = & ubi32_cgen_extract_handlers[0];

  cd->insert_operand = ubi32_cgen_insert_operand;
  cd->extract_operand = ubi32_cgen_extract_operand;

  cd->get_int_operand = ubi32_cgen_get_int_operand;
  cd->set_int_operand = ubi32_cgen_set_int_operand;
  cd->get_vma_operand = ubi32_cgen_get_vma_operand;
  cd->set_vma_operand = ubi32_cgen_set_vma_operand;
}
